...
/**
 * Representation of a Notification. This concerns the user notification as well
 * as more internal ones like System notification.
 */
...
public class Notification {
	...
	public boolean isForUser(@NonNull String userId) {
		System.out.println("isForUser userId " + userId + " this.audience: " + audience);
		if (getAudienceLength() == 0) {
			return false;
		}
		if (isBroadcast()) {
			return true;
